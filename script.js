...
function calcFontSize(minFontSize, maxFontSize, minScreenSize, maxScreenSize, screenSize) {
    let fontSize = (screenSize - minScreenSize) * (maxFontSize - minFontSize) / (maxScreenSize - minScreenSize) + minFontSize;
    return fontSize;
}
...
function generateSnowFlakes(){
    ...
    for (let i = 0; i < 10; i++) {
        randomHorizontalPositions.push(generateRandomHorizontalPosition()+fontSize);
    }
    snowflakes = {}
